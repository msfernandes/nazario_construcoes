...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Boleto.observacoes'
        db.add_column(u'gerenciador_despesas_boleto', 'observacoes',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Boleto.observacoes'
        db.delete_column(u'gerenciador_despesas_boleto', 'observacoes')
