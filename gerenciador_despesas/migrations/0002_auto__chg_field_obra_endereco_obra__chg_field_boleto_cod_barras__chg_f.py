...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'gerenciador_despesas_obra', 'endereco_obra', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Boleto.cod_barras'
        db.alter_column(u'gerenciador_despesas_boleto', 'cod_barras', self.gf('django.db.models.fields.CharField')(max_length=170))

        # Changing field 'Despesa.obra'
        db.alter_column(u'gerenciador_despesas_despesa', 'obra_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gerenciador_despesas.Obra'], null=True))

    def backwards(self, orm):

        # Changing field 'Obra.endereco_obra'
        db.alter_column(u'gerenciador_despesas_obra', 'endereco_obra', self.gf('django.db.models.fields.CharField')(max_length=75))

        # Changing field 'Boleto.cod_barras'
        db.alter_column(u'gerenciador_despesas_boleto', 'cod_barras', self.gf('django.db.models.fields.CharField')(max_length=150))

        # Changing field 'Despesa.obra'
        db.alter_column(u'gerenciador_despesas_despesa', 'obra_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['gerenciador_despesas.Obra']))
    ...
    models = {
        ...
        u'gerenciador_despesas.obra': {
            ...
            'endereco_obra': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
