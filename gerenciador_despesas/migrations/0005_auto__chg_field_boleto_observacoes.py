...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Boleto.observacoes'
        db.alter_column(u'gerenciador_despesas_boleto', 'observacoes', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Boleto.observacoes'
        db.alter_column(u'gerenciador_despesas_boleto', 'observacoes', self.gf('django.db.models.fields.TextField')(default=None))
